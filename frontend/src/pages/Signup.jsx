...
// ✅ Correct import (matches your folder & file name exactly)
  ...
  return (
    <div className='w-full min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex flex-col overflow-hidden relative'>
      <div className='flex-1 flex justify-center items-center flex-col p-[20px] pt-24'>
        ...
        {/* Signup Form */}
        <form
          className='w-[95%] max-w-[520px] bg-white/10 backdrop-blur-xl shadow-2xl border border-white/20 flex flex-col items-center justify-center gap-[24px] px-[24px] py-[48px] rounded-3xl relative z-20'
          onSubmit={handleSignUp}
        >
          <div className="absolute inset-4 bg-gradient-to-br from-purple-500/20 to-blue-500/20 rounded-2xl"></div>

          <div className='relative z-10 flex flex-col items-center gap-6'>
            <h1 className='text-white text-[26px] sm:text-[32px] font-bold bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 bg-clip-text text-transparent text-center'>
              Join SYRA AI
            </h1>
            <p className='text-white/80 text-center text-sm sm:text-base'>Create your account and start your AI journey</p>
          </div>
          ...
          <div className='w-full space-y-5 relative z-10'>
            ...
            <div className='w-full h-[52px] sm:h-[64px] border-2 border-purple-400/50 bg-white/5 backdrop-blur-lg text-white rounded-full text-[16px] sm:text-[18px] relative focus-within:border-purple-400 focus-within:ring-2 focus-within:ring-purple-400/20 transition-all duration-300'>
              ...
              {!showPassword &&
                <IoEye
                  className='absolute top-[16px] sm:top-[20px] right-[18px] sm:right-[24px] w-[20px] h-[20px] sm:w-[25px] sm:h-[25px] text-white cursor-pointer hover:text-purple-400 transition-colors'
          ...
          {err.length > 0 &&
            <p className='text-red-400 text-[14px] sm:text-[17px] text-center bg-red-500/10 backdrop-blur-sm rounded-lg px-4 py-3 border border-red-500/20'>
              *{err}
            </p>
          }
          ...
          <p className='text-white/80 text-[14px] sm:text-[18px] text-center relative z-10 mt-2'>
            ...
            <span
              className='text-purple-400 hover:text-purple-300 cursor-pointer ml-2 font-semibold transition-colors'
